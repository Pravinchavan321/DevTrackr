  ...
  return (
    <div className="space-y-8 max-w-4xl selection:bg-indigo-500 selection:text-white">
      ...
      <div className="pb-4 border-b border-gray-800">
        ...
        <p className="text-sm text-gray-400">Manage your profile details and developer workspace integrations.</p>
      </div>

      {/* Profile Card Section */}
      <div className="bg-gray-900 border border-gray-850 rounded-xl p-6 space-y-6">
        <div className="flex items-center space-x-3.5 pb-4 border-b border-gray-800">
          <div className="h-10 w-10 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 font-semibold border border-gray-700/50">
          ...
          <div>
            ...
            <p className="text-xs text-gray-450">Details regarding your DevTrackr account.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="bg-gray-950 border border-gray-850 rounded-lg px-4 py-2.5 text-sm text-gray-200">
              {user?.name || 'Developer'}
            </div>
          </div>
